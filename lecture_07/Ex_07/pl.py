...
#x, gofr, err = np.loadtxt("output.gave.0",usecols=(0,1,2), unpack='true')
x, epot, err = np.loadtxt("output.pres.0",usecols=(0,2,3), unpack='true')

#plt.errorbar(x,gofr, yerr=err)
plt.errorbar(x,epot, yerr=err)
